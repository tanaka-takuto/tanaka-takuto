...
![](https://img.shields.io/badge/Go-3months-555555?logo=Go&logoColor=FFFFFF&labelColor=00ADD8)
...
## フレームワーク
![](https://img.shields.io/badge/gorm-3months-555555?logo=&logoColor=FFFFFF&labelColor=00ADD8)
...
## 【転職Webサービス】(2022/03 ~ )
バックエンドエンジニアとして参画。作成中・・・

| 担当業務 | フロントエンド | バックエンド | その他 |
| :------: | :------------: | :----------: | :----: |
| 設計 / 開発 | ![PHP] ![HTML5] ![CSS3]  | ![Go] ![gorm]  | ![MySQL] ![Slack] ![Redmine] ![GoogleWorkspace] ![Jenkins] ![Docker] ![Nginx] ![AmazonAWS]  |
...
| 担当業務 | フロントエンド | バックエンド | その他 |
| :------: | :------------: | :----------: | :----: |
| 要件定義 / 設計 / 開発 | ![TypeScript] ![HTML5] ![CSS3] ![Pug] ![Sass] ![Nuxt.js] ![Vue.js] ![Vuetify]  | ![TypeScript]  | - |
